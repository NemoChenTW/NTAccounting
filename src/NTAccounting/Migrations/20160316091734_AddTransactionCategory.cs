    ...
    public partial class AddTransactionCategory : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MainTransactionCategory", x => x.ID);
                });
            migrationBuilder.CreateTable(
                name: "SubTransactionCategory",
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubTransactionCategory", x => x.ID);
                    table.ForeignKey(
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_UserGroupApplicationUser_ApplicationUser_ApplicationUserID", table: "UserGroupApplicationUser");
            migrationBuilder.DropForeignKey(name: "FK_UserGroupApplicationUser_UserGroup_UserGroupID", table: "UserGroupApplicationUser");
            migrationBuilder.DropTable("SubTransactionCategory");
            migrationBuilder.DropTable("MainTransactionCategory");
            migrationBuilder.AddForeignKey(
                name: "FK_IdentityRoleClaim<string>_IdentityRole_RoleId",
                table: "AspNetRoleClaims",
                column: "RoleId",
