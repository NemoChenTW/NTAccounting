...
{
    public partial class FixNameOfRepresentativeGroupID : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "RepresentativeGrpupID", table: "AspNetUsers");
            migrationBuilder.AddColumn<int>(
                name: "RepresentativeGroupID",
                table: "AspNetUsers",
                nullable: false,
                defaultValue: 0);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_UserGroupApplicationUser_ApplicationUser_ApplicationUserID", table: "UserGroupApplicationUser");
            migrationBuilder.DropForeignKey(name: "FK_UserGroupApplicationUser_UserGroup_UserGroupID", table: "UserGroupApplicationUser");
            migrationBuilder.DropColumn(name: "RepresentativeGroupID", table: "AspNetUsers");
            migrationBuilder.AddColumn<int>(
                name: "RepresentativeGrpupID",
                table: "AspNetUsers",
                nullable: false,
                defaultValue: 0);
            migrationBuilder.AddForeignKey(
