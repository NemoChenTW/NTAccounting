...
{
    public partial class AddManyToManyRelationBetweenUserGroupAndApplicationUser : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserGroupApplicationUser", x => new { x.UserGroupID, x.ApplicationUserID });
                    table.ForeignKey(
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_ApplicationUser_UserId", table: "AspNetUserRoles");
            migrationBuilder.DropForeignKey(name: "FK_FinancialAccount_FinancialAccountType_TypeID", table: "FinancialAccount");
            migrationBuilder.DropTable("UserGroupApplicationUser");
